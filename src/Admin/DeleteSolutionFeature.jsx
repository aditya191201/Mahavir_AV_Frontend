...
function DeleteSolutionFeature() {
  ...
  const handleClick = () => {
    ...
    axios.delete(url + "/deletesolutionfeatures/" + modelNum + "/" + title, {
      headers: {
          ...
          <div className="form-contain">
            <div class="wrapper-form">
              ...
              <div class="form-1">
                  ...
                  <div class="inputfield">
                        <input type="submit" value="Delete Solution Feature" onClick={handleClick} class="btn" />
                  </div>
...
export default DeleteSolutionFeature