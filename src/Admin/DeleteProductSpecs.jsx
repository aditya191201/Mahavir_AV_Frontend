...
function DeleteProductSpecs() {
  ...
  const handleClick = () => {
    ...
    axios.delete(url + "/deleteProductSpecs/" + modelNum + "/" + title, {
      headers: {
          ...
          <div className="form-contain">
            <div class="wrapper-form">
              ...
              <div class="form-1">
                  ...
                  <div class="inputfield">
                        <input type="submit" value="Delete Product Specification" onClick={handleClick} class="btn" />
                  </div>
...
export default DeleteProductSpecs