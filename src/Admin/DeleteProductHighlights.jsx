...
function DeleteProductHighlights() {
  ...
  const handleClick = () => {
    ...
    axios.delete(url + "/deleteAdditionalFeatures/" + modelNum + "/" + title, {
      headers: {
          ...
          <div className="form-contain">
            <div class="wrapper-form">
              ...
              <div class="form-1">
                  ...
                  <div class="inputfield">
                           <input type="submit" value="Delete Product Highlight" onClick={handleClick} class="btn" />
                  </div>
...
export default DeleteProductHighlights